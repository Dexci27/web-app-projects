...
// remove the space for adding the task information after clicking on the button
    ...
    var p = document.getElementById("test");
        p.innerHTML = p.innerHTML + `; checkbox id : ${checkbox.id},  task id : ${task.id}, taskContainer id : ${taskContainer.id}, taskIdList : ${taskIdList}`;
...
// puts the reset id as id of the task containers
    ...
    p.innerHTML = `taskIdList : ${taskIdList}, TaskId : ${containersId}, ContainerId : ${divList}, taskList : ${taskList}`;
...
// creates a paragraph for the task name with the content of the paragraph being the new value of the input   
    var task = document.createElement("p");
    task.innerHTML = newTaskName + " " + taskContainer.id;
    task.id = "task" + taskContainer.id;
    task.classList.add("task");
...
// add the tasks elements to the taskContainer
    ...
    p.innerHTML = `taskIdList : ${taskIdList}; taskList : ${taskList}; containersId : ${containersId}`;
};
